...
METAL_FUNC void radix7(thread fft_complex_t<T>* x, thread fft_complex_t<T>* y) {
  // Rader's algorithm
  auto inv = fft_make_complex<T>(1.0 / 6.0, -1.0 / 6.0);
  ...
  y[2] = complex_mul_conj<T>(y[2], fft_make_complex<T>(2.44013336, -1.02261879));
  y[3] = complex_mul_conj<T>(y[3], fft_make_complex<T>(2.37046941, -1.17510629));
  ...
  y[6] = complex_mul_conj<T>(y[6], fft_make_complex<T>(-2.44013336, -1.02261879));
...
METAL_FUNC void radix10(thread fft_complex_t<T>* x, thread fft_complex_t<T>* y) {
  fft_complex_t<T> w[4];
...
template <typename T>
METAL_FUNC void radix11(thread fft_complex_t<T>* x, thread fft_complex_t<T>* y) {
  // Rader's algorithm
  auto inv = fft_make_complex<T>(1.0 / 10.0, -1.0 / 10.0);
  ...
  // b_q
  y[1] = complex_mul_conj<T>(y[1], fft_make_complex<T>(-1, 0));
  y[2] = complex_mul_conj<T>(y[2], fft_make_complex<T>(0.955301878, -3.17606649));
  ...
  y[7] = complex_mul_conj<T>(y[7], fft_make_complex<T>(2.07016210, -2.59122150));
  y[8] = complex_mul_conj<T>(y[8], fft_make_complex<T>(-2.54127802, 2.13117479));
  y[9] = complex_mul_conj<T>(y[9], fft_make_complex<T>(2.63610556, -2.01269656));
  y[10] = complex_mul_conj<T>(y[10], fft_make_complex<T>(-0.955301878, -3.17606649));
...
template <typename T, bool raders_perm>
METAL_FUNC void radix12(thread fft_complex_t<T>* x, thread fft_complex_t<T>* y) {
  fft_complex_t<T> w[6];
...
template <typename T>
METAL_FUNC void radix13(thread fft_complex_t<T>* x, thread fft_complex_t<T>* y) {
  // Rader's algorithm
  auto inv = fft_make_complex<T>(1.0 / 12.0, -1.0 / 12.0);
  ...
  // b_q
  y[1] = complex_mul_conj<T>(y[1], fft_make_complex<T>(-1, 0));
  y[2] = complex_mul_conj<T>(y[2], fft_make_complex<T>(3.07497206, -1.88269669));
  y[3] = complex_mul_conj<T>(y[3], fft_make_complex<T>(3.09912468, 1.84266823));
  y[4] = complex_mul_conj<T>(y[4], fft_make_complex<T>(3.45084438, -1.04483161));
  y[5] = complex_mul_conj<T>(y[5], fft_make_complex<T>(0.91083583, 3.48860690));
  y[6] = complex_mul_conj<T>(y[6], fft_make_complex<T>(-3.60286363, 0.139189267));
  y[7] = complex_mul_conj<T>(y[7], fft_make_complex<T>(3.60555128, 0));
  y[8] = complex_mul_conj<T>(y[8], fft_make_complex<T>(3.60286363, 0.139189267));
  y[9] = complex_mul_conj<T>(y[9], fft_make_complex<T>(0.91083583, -3.48860690));
  y[10] = complex_mul_conj<T>(y[10], fft_make_complex<T>(-3.45084438, -1.04483161));
  y[11] = complex_mul_conj<T>(y[11], fft_make_complex<T>(3.09912468, -1.84266823));
  y[12] = complex_mul_conj<T>(y[12], fft_make_complex<T>(-3.07497206, -1.88269669));
